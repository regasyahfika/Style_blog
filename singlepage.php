<?php 
	...
	//menampilkan tabel semua data pada berita = berita.*
    $query = "SELECT berita.*, kategori.nama as nama_kategori, admin.nama_lengkap as nama_lengkap FROM berita JOIN kategori ON kategori.id = berita.id_kategori JOIN admin ON admin.id = admin.id WHERE berita.id = $idberita";

	$berita = mysqli_query($koneksi, $query);
...
<div class="banner-1">
	...
	<div class="container">
		<div class="col-md-9 technology-left">
			<div class="agileinfo">
			<?php 
			while ($data = mysqli_fetch_assoc($berita)):
			?>
